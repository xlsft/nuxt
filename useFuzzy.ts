import Fuse, { IFuseOptions } from 'fuse.ts'

/**
 * ## useFuzzy
 * Creates a fuzzy search instance using `Fuse.ts` for searching through a list of items.
 *
 * @param list The array of items to search through.
 * @param options (Optional) Configuration options for the `Fuse.ts` instance, such as search keys, threshold, etc.
 *
 ...
 * 
 * `Fuse.ts` docs: https://www.fusejs.io
 */
