import Fuse, { IFuseOptions } from 'fuse'

/**
 * ## useFuzzy
 * Creates a fuzzy search instance using `Fuse` for searching through a list of items.
 *
 * @param list The array of items to search through.
 * @param options (Optional) Configuration options for the `Fuse` instance, such as search keys, threshold, etc.
 *
